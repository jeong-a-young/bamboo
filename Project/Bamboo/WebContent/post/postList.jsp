	...
	<div class="postList">
		<table class="postListTable">
			...
			<%
				...
				// postType이 '전체'라면
				if (request.getParameter("postType").equals("전체")) {
			...
			<%
				...
				} else if (request.getParameter("postType").equals("공지게시판")) {
					// post_type이 '공지게시판'인 게시글 목록을 불러오는 함수 호출
			...
			<%
					...
					// post_type이 '스마트전자과게시판', '정보통신과게시판', '소프트웨어개발과게시판',
